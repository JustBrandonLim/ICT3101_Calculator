...
#line hidden
#line 9
  testRunner.When("I have entered 10 initial failure intensity and 50 as average expected number of " +
                        "failures and 100 as total number of failures into the calculator and press Failu" +
...
#line hidden
#line 14
  testRunner.When("I have entered 100 as total number of failures and 10 as initial failure intesnis" +
                        "ty and 10 for number of CPU hours into the calculator and press Expected Failure" +
                        "s", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 15
  testRunner.Then("the Expected Failure result should be 63", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
